# Silent Providence — Master Roadmap
*Built by Lordy and Sparkle. Started 2026-05-02.*
*This is the map. Stories get written from here. Questions stay open until the story earns the answer.*

---

> Humanity reached for the stars for no measurable reason.
> A dumb potato alien latched onto a failing ship because it was cold.
...
## I. THE ERAS
*The full arc of the story — from Earth to the ending. Each era needs its own document eventually, and at least one mini story set inside it.*

| Era | Period | Status | Needs |
|-----|--------|--------|-------|
| **Earth — Before the Launch** | Pre-mission | Not written | The world that was left behind. What made the Holding possible. What they were fleeing — or building toward. |
...
| **The Ending** | Future | Theology written, story not written | The Tatos protecting the Murmur. The scene where the law runs out. How it actually looks on the page. |
...
## II. FACTIONS
*The sides. Not good vs. evil — two faiths, one origin, opposite conclusions.*
...
## III. SPECIES
*Every species that matters to the story needs a file.*
...
## IV. KEY FIGURES
*The faces the story needs. A story without faces is philosophy. These are the people.*

| Figure | Role | Status | Needs |
|--------|------|--------|-------|
| **Mundo** | First Tato, the original | Named, described | What happened after first contact. His whole life, briefly. |
...
## V. LOCATIONS
*Where things happen. At least one vivid location per era.*

| Location | Era | Status | Needs |
|----------|-----|--------|-------|
| **Earth — pre-launch** | Before crossing | Not written | The feel of the world being left behind |
| **Proxima Centauri b** | Arrival onward | Sketched | Name. What the crystal colony looks like after a thousand years of civilization. |
| **[The Bar]** | White Throne era | Named in notes | A city at the edge of White Throne reach. The last place the Murmur gathers openly. |
| **[A White Throne tribunal world]** | White Throne era | Not written | What it looks like after judgment arrives. The law executing perfectly. |
| **[A Murmur stronghold]** | White Throne era | Not written | Hidden. Moving. What does resistance look like when you're outnumbered? |
| **[The Golden Era capital]** | Golden Era | Not written | The place where joy was most concentrated. What was it? |

### Open Questions — Locations
- What is the name of the first colony on Proxima b?
- Where is the White Throne — one location, or everywhere at once?
- Does the Bar have a name?
- What planet is the game's campaign set on?

---

## VI. TECHNOLOGY
*The tools that shape the conflict.*

| Technology | Role | Status | Needs |
|------------|------|--------|-------|
| **The Mobius Drive** | First warp drive — controlling it controls the pace of judgment | Sketched | How it works (loosely). Why it's the thing everyone wants. What it costs to use. |
| **Human Robots** | Tato interface with humanity | Described | What they look like during the White Throne era — are they contraband? |
| **Crystal Energy** | Proxima b's power source | Sketched | How humanity scaled it. Whether other planets have it. |
| **White Throne systems** | The judgment infrastructure | Not written | How it calculates, tracks, delivers verdicts. What the machinery of judgment looks like. |

---

## VII. MINI STORIES
*Show don't tell. The theology lives in the scenes, not the theology doc. These are the stories to write — each one plants a seed the reader carries forward.*

### Seed Stories — To Write

| Story | Era | What It Shows | Status |
|-------|-----|---------------|--------|
| **Mundo's whole life** | Arrival → Golden Era | Potato Hope made flesh. The creature who started everything. | Not written |
| **First contact with a new species** | Early Expansion | The moment grace expanded — and the law came with it. The alien who received compassion. Whether they extended it. | Not written |
| **A Golden Era Tato competition** | Golden Era | Joy as civilization. What a thousand years of peace looks like from inside. | Not written |
| **The Fracture moment** | End of Golden Era | The White Throne's first verdict. The moment the math said: now. Whoever was in the room. | Not written |
| **A White Throne tribunal** | White Throne era | The law executing perfectly. Cold, not cruel — which is worse. The Pharisee parallel without naming it. | Not written |
| **The founding of the Murmur** | Early White Throne era | The first human to defect. What they saw that made them leave. What they built instead. | Not written |
| **Ember's last record** | White Throne era | The Archivist watching the Golden Era end. What she chose to keep. What she let go. | Not written |
| **The Tatos and the Murmur** | The ending | The closing of the ledger. The scene the whole saga is building toward. | Theology written — scene not written |

### Notes on Writing Mini Stories
- Start with a character in a specific moment, not a historical event
- The theology emerges from the character's choice — never stated directly
- Each story should work as a standalone — the reader doesn't need the full lore to feel it
- Aim for 500–1500 words per story to start. Length follows the scene, not the outline.

---

## VIII. OPEN QUESTIONS — MASTER LIST
*Everything that still needs an answer. Don't force them. Let the story earn them.*

**World:**
- The Holding's formal name
- First colony planet name
- What year does humanity launch?
- Does Earth survive — and if so, what does it become?

**Story:**
- What triggers the Fracture?
- Does the cosmic threat arrive anyway — or did the White Throne prevent it (or cause it)?
- Does the White Throne war end in the main game's timeline, or is the ending the Tatos story?
- Who is the alien leader who completes the ending?

**Characters:**
- Holding founder — name, voice
- White Throne — does it have a face?
- Murmur founder — name, story
- Ember — full character

**Species:**
- Names and characters for the two unnamed major species
- Which species sided with the White Throne willingly?

**Locations:**
- First colony name
- The Bar's name
- The game's campaign planet

---

*Split files out of the world bible when a section gets long enough to scroll through.*
*Write the mini stories when a character's voice arrives. Don't force it — wait for the one that wants to be told first.*
